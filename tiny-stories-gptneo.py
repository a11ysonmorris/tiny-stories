...
config = GPTNeoConfig(
    ...
    max_position_embeddings=256, # The maximum sequence length this will ever see.
    hidden_size=128,             # The dimension of the embedding and hidden states.
    ...
    num_heads=4,               # The number of attention heads per layer.
    intermediate_size=512,       # The size of the vectors in the feedforward networks.
    window_size=32,             # If using local attention, the size of the sliding window.
    activation_function= "gelu_new"     # Nonlinear activation function the feedfoward networks.
)
